	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<p>La pratique, entraînement et matchs à domicile, se déroule au gymnase de l'Europe à Châtillon-sur-Chalaronne, Avenue Francois Mitterand.
				</p>
			</div>
			<div class="col-sm-6">
				<h3>Comment se fait l'inscription ?</h3>
				<p>L'inscription ne se fait pas sur le site mais directemnt au club où il faut se présenter aux entraîneurs aux horaires d'entraînement</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3>Niveau Requis?</h3>
				<p>Le club porté par des bénévoles rassemblés autour de la passion du hand accueille toutes les personnes ayant envie de jouer.<br>
						La variété des équipes et des niveaux permet à chacun de trouver sa place dans nos différentes équipes.
				</p>
			</div>
			<div class="col-sm-6">
		...
		<div class="jumbotron top-space">
			<h4>Le meilleur conditionneur complet. Idéal pour les enfants et les adultes, car il aide à développer les deux côtés du corps et du cerveau pour faciliter l'apprentissage. Si vous ne l'avez pas déjà fait, venez essayer ou nous voir lors d'un de nos nombreux matchs à domicile.</h4>
